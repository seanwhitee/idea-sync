...
<template>
  ...
  >
    ...
    <div class="flex items-center">
      <NuxtLink
        to="/signin"
        class="flex items-center justify-center text-white py-2 px-4 cursor-pointer"
        >登入</NuxtLink
      >
      <NuxtLink to="/signup"
        ><button
          class="flex bg-gradient-to-tr from-indigo-500 via-purple-500 to-purple-600 text-white/90 items-center rounded-s-lg rounded-e-lg px-3 ring-1 py-2 text-xs font-bold cursor-pointer"
        >
          立即註冊
        </button></NuxtLink
      >
